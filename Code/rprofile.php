      ...
      <div class="row">
          <div class="col s8">
            ...
            <ul id="dropdown" class="dropdown-content">
              <li><a href="rprofile.php"><i class="material-icons">person</i>Profile</a></li>
              <li><a href="rupdate.php"><i class="material-icons">create</i>Update profile</a></li>
              <li><a href="rchangepass.php"><i class="material-icons">help</i>Change password</a></li>
              <li class="divider"></li>
...
<li class="white"><a href="additem.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">keyboard_arrow_right</i>Add Item</a></li>
<li class="white"><a href="viewrequest.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">keyboard_arrow_right</i> View Request</a></li>
...
<li class="white"><a href="rest_report.php" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">keyboard_arrow_right</i>Report</a></li>
        ...
        <section >
			<br><br>			 
			  <h2 class="center">Profile</h2>
                ...
                <form method="post" action="fa1.php" name="Profile" >
					...
					<div class="container1">
                      <table class="center">
						    ...
						    <tbody>
						      <tr>
						        <td><i class="material-icons red-text left">account_circle</i><span><strong>Name</strong></span></td>
								<td><?php echo $rsedit[name]; ?></td>  
					          </tr>
						      <tr>
						        <td><i class="material-icons red-text left">location_on</i><span><strong>Address</strong></span> </td>
								<td><?php echo $rsedit[address]; ?></td>
						     
					          </tr>
							  <tr>
						        <td ><i class="material-icons red-text left">domain</i><span><strong>City</strong></span> </td>
								<td><?php echo $rsedit[city]; ?></td>
						        
					          </tr>
						      
						      <tr>
						        <td ><i class="material-icons red-text left">phone</i><span><strong>Phone</strong></span></td>
								<td><?php echo $rsedit[phone]; ?></td>
						        
					          </tr>
						      <tr>
						        <td ><i class="material-icons red-text left">email</i><span><strong>Email ID</strong></span>  </td>
						        <td><?php echo $rsedit[mail]; ?></td>
					         </tr>
							 <tr>
						        <td ><i class="material-icons red-text left">transform</i><span><strong>Type</strong></span> </td>
								<td><?php echo $rsedit[type]; ?></td>
