...
<body class="u-body"><header class="u-align-center u-clearfix u-header u-header" id="sec-5f00"><div class="u-clearfix u-sheet u-sheet-1">
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <section >
			<br><br>			 
			  <h2 class="center">Add Food</h2>
						<form method="post" action="foodinsert.php" name="Food" >
					...
					<div class="container1">
                      <table class="center">
						    ...
						    <tbody>
						     <tr>
					     <td width="246">Food </td>
						 <td><input type="text" name="food" id="food" value="Food"></td>
					</tr>
						      
					 <tr>
					     <td >Quantity </td>
						 <td><input type="number" name="qty" id="qty" value="Quantity"></td>
					 </tr>
