...
<body class="u-body"><header class="u-align-center u-clearfix u-header u-header" id="sec-5f00"><div class="u-clearfix u-sheet u-sheet-1">
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <section >
			<br><br>			 
			  <h2 class="center">View/Request Food</h2>
			   <form method="post" >
					...
					<div class="container">
							...
							if(!isset($_SESSION)) { session_start(); }
								...
								{
								$sql1 = "SELECT restaurant,foodname,qty FROM food";
							  ...
							  while($rs = mysqli_fetch_array($qsql1))
							  {
								  ...
								  echo "<td>".$rs[qty]."</td>";
								  echo "<td>
								  <button class='black red-text waves-effect waves-light btn submitbtn' type='submit'  name='submit' id='submit' value='Submit'>Request</button>
								  </td>";
								  echo "</tr>";
							  }
								echo "</table>";
