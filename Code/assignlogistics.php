...
<body class="u-body"><header class="u-align-center u-clearfix u-header u-header" id="sec-5f00"><div class="u-clearfix u-sheet u-sheet-1">
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <section >
			<br><br>			 
			  <h2 class="center">Available Logistics</h2>
			   <form method="post">
                   ...
                   <center>
              <a href="assign.php"><button class=" black red-text waves-effect waves-light btn submitbtn" type="submit"  name="submit"  value="Assign Logistics">Assign Logistics</button></a>
                  </center>
