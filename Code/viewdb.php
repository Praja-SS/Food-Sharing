        ...
        <div class="row">
          <div class="col l4 s12"></div>
            <ul class="collapsible">
              <li>
                <div class="collapsible-header u-text-palette-2-base text-darken-1">1.Food</div>
			  ...
			  <li>
                <div class="collapsible-header u-text-palette-2-base text-darken-1">2.Request_Food</div>
                <div class="collapsible-body"><?php
								if(!isset($_SESSION)) { session_start(); }
								{include("dbconnection.php");

						
							$sql1 = "SELECT * FROM reqfood";
							  $qsql1 = mysqli_query($con,$sql1);
							  echo "<table class='center'>
										<tr>
										<th>S.No</th>
                ...
                <div class="collapsible-header u-text-palette-2-base text-darken-1">3.NGO_Logistics</div>
                <div class="collapsible-body"><?php
								if(!isset($_SESSION)) { session_start(); }
								{include("dbconnection.php");

						
							$sql1 = "SELECT * FROM ngo_log";
							  $qsql1 = mysqli_query($con,$sql1);
							  echo "<table class='center'>
										<tr>
										<th>S.No</th>
