    ...
    <div class="content">
      <div id="content-wrap">
        <!-- all other page-content -->
          ...
          <section >
					<br><br>	 
			<h2 class="center">Update Information</h2>
							
            <form method="post" action="fa2.php" name="updateprofile" >
				...
				<tbody>
					...
					<tr>
					    <td width="246">City </td>
						<td width="187"><input type="text" name="city" id="city" value="<?php echo $rsedit[city]; ?>" autofocus></td>
					</tr>
						      
					 <tr>
					     <td >Phone </td>
						 <td><input type="number" name="phone" id="phone" value="<?php echo $rsedit[phone]; ?>"></td>
					 </tr>
					<tr>
						<td >Email ID </td>
              ...
              <section>
                  <center>
                    <button class=" black red-text waves-effect waves-light btn submitbtn" type="submit"  name="submit" id="submit" value="Submit">Submit</button></center>
			  </section>
          </form>
	  <p>&nbsp;</p>
