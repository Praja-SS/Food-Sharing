...
<li class="white"><a href="addarticle.html" class="waves-effect waves-blue"><i class="material-icons  right style="margin-right:0;">keyboard_arrow_right</i> Add Article</a></li>
  ...
  <div class="content">
      <div id="content-wrap">
		...
		<section >
			...
			<h2 class="center">Feedback</h2><br><br>
					...
					<div class="container1">
							...
							<?php
								...
								$sql1 = "SELECT name,email,message FROM contact_us";
					...
					<center>
                   <form>
				   <input type="button" onclick="window.location.href='mail.php'" value="Send Mail"></center>
					</form>
				</section>		
