...
<body class="u-body"><header class="u-align-center u-clearfix u-header u-header" id="sec-5f00"><div class="u-clearfix u-sheet u-sheet-1">
  ...
  <div class="content">
      <div id="content-wrap">
        ...
        <section >
			<br><br>			 
			  <h2 class="center">Assign Logistics</h2>
			  
			  <form method="post" action="insertlog.php" name="insertlogistics" >
					...
					<div class="container1">
                      <table class="center">
						    ...
						    <tbody>
						     <tr>
					     <td width="246">Logistics </td>
						 <td><input type="text" name="logi" id="logi" value="Logistics"></td>
					</tr>
					<tr>
					     <td >Restaurant </td>
						 <td><input type="text" name="restaurant" id="restaurant" value="Restaurant"></td>
					 </tr>      
					 <tr>
					    <tr>
					...
					<section>
                  <center>
                    <button class=" black red-text waves-effect waves-light btn submitbtn" type="submit"  name="submit" id="submit" value="Assign">Assign</button></center>
			  </section>
			    </form>
